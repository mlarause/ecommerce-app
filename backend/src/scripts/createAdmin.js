...
var createAdmin = function () { return __awaiter(void 0, void 0, void 0, function () {
    var existingAdmin, salt, hashedPassword, admin, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 9, , 10]);
                return [4 /*yield*/, mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/ecommerce')];
            case 1:
                _a.sent();
            ...
            case 3:
                _a.sent();
                return [2 /*return*/];
            case 4: return [4 /*yield*/, bcrypt_1.default.genSalt(10)];
            case 5:
                salt = _a.sent();
